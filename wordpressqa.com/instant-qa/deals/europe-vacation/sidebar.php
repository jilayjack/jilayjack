    ...
    <div id="leftCol" class="left">
        ...
        <div class="siteCategories greyBox">
            <div class="greyBoxInner">
                <ul>
                    	<li class="cat-item cat-item-7"><a href="category\activities\activities.php">Activities</a>
</li>
	<li class="cat-item cat-item-9"><a href="category\beaches\beaches.php">Beaches</a>
</li>
	<li class="cat-item cat-item-4"><a href="category\car-rentals\car-rentals.php">Car Rentals</a>
</li>
	<li class="cat-item cat-item-6"><a href="category\cruises\cruises.php">Cruises</a>
</li>
	<li class="cat-item cat-item-8"><a href="category\deals\deals.php">Deals</a>
<ul class='children'>
	<li class="cat-item cat-item-10"><a href="category\deals\last-min-deals\last-min-deals.php">Last Min Deals</a>
</li>
</ul>
</li>
	<li class="cat-item cat-item-5"><a href="category\flights\flights.php">Flights</a>
</li>
	<li class="cat-item cat-item-3"><a href="category\hotels\hotels.php">Hotels</a>
</li>
                </ul>
            </div>
        </div>
