...
<div class="header" id="home">
				<div class="container">
		<ul>
		    <li> <a href="userside.php" data-toggle="modal" data-target="#myModal"> Home </a></li>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="userside.html">Home <span class="sr-only">(current)</span></a></li>
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Jewellery <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="images/d.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html">Bresllet </a></li>
											<li><a href="mens.html">Ring</a></li>
											<li><a href="mens.html">dsas</a></li>
											<li><a href="mens.html">Silver</a></li>
											</ul>
									</div>
