                      ...
                      echo '<div class="col-md-3 product-men single">';
								echo '<div class="men-pro-item simpleCart_shelfItem">';
									echo '<div class="men-thumb-item">';
										echi '<img src="'.$row["product_image1"].'" alt="" class="pro-image-front">';
										echo '<img src="'.$row["product_image1"].'" alt="" class="pro-image-back">';
											echi '<div class="men-cart-pro">';
												echp '<div class="inner-men-cart-pro">';
									...
									echo '<div class="item-info-product ">';
										echo '<h4><a href="single.php">Sleeveless Solid Blue Top</a></h4>';
										...
										echo '<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">';
															echo '<form action="#" method="post">';
																echo '<fieldset>';
																	echo '<input type="submit" name="submit" value="BUY" class="button">';
																echo '</fieldset>';
															echo '</form>';
														echo '</div>';
