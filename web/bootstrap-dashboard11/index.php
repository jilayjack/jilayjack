...
if($result->num_rows>0){
    while($row =$result->fetch_assoc())
    {
       ...
       echo '<td> <img src="'.$row["product_img"].'"> </td>';

       echo '<td>'. $row["action"]. '</td>';
       echo '<td>'. $row["cat_name"]. '</td>';
       
       echo '<td><a href="productdel.php?id='.$row["product_id"].'"><span class="glyphicon glyphicon-trash "></span> </a> </td>';
           echo '<td><a href="productupdate.php?id='.$row["product_id"].'"> <span class="glyphicon glyphicon-pencil "></span></a> </td>';
...
<form>
<center>
<a href="productinsert.php" class="btn btn-danger">Insert</a>
<a href="catinsert.php" class="btn btn-danger">Insert-Categaries</a>
