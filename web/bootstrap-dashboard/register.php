      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>admin</span><strong class="text-primary">sign up</strong></div>
               <form id="register-form" method="post" action="adminadd.php">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    <input  type="text" placeholder="enter mobile no" name="txtmobile" required>
              </div>
             ...
             <input  type="file" name="txtimg" required>
              ...
              <input id="register" type="submit" value="Register" class="btn btn-primary" name="btnadd">
