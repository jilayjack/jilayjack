...
<div class="container">
	<div class="check">	 
		 ...
		 <div class="col-md-9 cart-items">
			...
			{
				$res=$obj->getproduct($row["pk_product_id"]);
				$_row=$res->fetch_assoc();
		echo '	 <div class="cart-header2">';
		echo '		 <a class="close2" href="cartdelete.php?id='.$row["pk_product_id"].'"> </a>';
		...
		echo '				<h3><a href="#">'.$_row["product_name"].'</a><span>Model No: '.$_row["product_id"].'</span></h3>';
