...
?>
<body>
<h1><center>Insert product</h1><br><br><center>

<form method="post" action="productinsert1.php" enctype="multipart/form-data">
<table class="table">

<tr><td>product Name<td><input type="text" name="txtname" required=""></tr>
