...
<!DOCTYPE html>
<!-- saved from url=(0050)https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39 -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="Bootstrap Snippet User Profile Sidebar using HTML CSS Bootstrap _ Bootsnipp.com_files\bootstrap.min(1).css" rel="stylesheet" id="bootstrap-css">
    <style type="Bootstrap Snippet User Profile Sidebar using HTML CSS Bootstrap _ Bootsnipp.com_files\text/css">
...
.dropdown ul.dropdown-menu:before {
    ...
    <script src="Bootstrap Snippet User Profile Sidebar using HTML CSS Bootstrap _ Bootsnipp.com_files\jquery-1.10.2.min.js.download"></script>
    <script src="Bootstrap Snippet User Profile Sidebar using HTML CSS Bootstrap _ Bootsnipp.com_files\bootstrap.min.js(1).download"></script>
...
//$name=$row["name"];
//echo $name;
echo '<div class="col col_4 iamgurdeep-pic">';

echo '<img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src='.$row["user_image"].'>';
echo '</div>';
?>
<!--<div class="edit-pic">
...
<div class="username">
    ...
    <a href="https://www.instagram.com/gurdeeposahan/" target="_blank" class="btn-o"> <i class="fa fa-plus"></i> Follow </a>
     ...
     <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-ellipsis-v pull-right"></span></a>
          <ul class="dropdown-menu pull-right">
            <li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Video Call <i class="fa fa-video-camera"></i></a></li>
            <li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Poke <i class="fa fa-hand-o-right"></i></a></li>
            <li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Report <i class="fa fa-bug"></i></a></li>
            <li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Block <i class="fa fa-lock"></i></a></li>
          </ul>
        </li>
      </ul>
		...
		<li>
			...
			<ul class="submenu">
				<li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><i class="fa fa-calendar left-none"></i> Date of Birth : 03/09/1994</a></li>
				<li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Address : INDIA,Punjab</a></li>
				<li><a href="mailto:gurdeepjawaddi94@gmail.com">Email : gurdeepjawaddi94@gmail.com</a></li>
				<li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#">Phone : +91 85680-79956</a></li>
			</ul>
		</li>
		<li class="default open">
			<div class="link"><i class="fa fa-code"></i>Professional Skills<i class="fa fa-chevron-down"></i></div>
			<ul class="submenu">
				<li><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><span class="tags">Adobe Photoshop</span> <span class="tags">Corel Draw</span> <span class="tags">CSS</span> <span class="tags">Css 3</span> 
		...
		<li>
			...
			<ul class="submenu">
				<li class="photosgurdeep"><a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="./gurdeeposahan.jpg">                 
				</a>
                <a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="./gurdeeposahan.jpg">                 
    			</a>
                <a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="./gurdeeposahan.jpg">                 
    			</a>
                <a href="https://d2d3qesrx8xj6s.cloudfront.net/iframe/z4P39#"><img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="./gurdeeposahan.jpg">                 
