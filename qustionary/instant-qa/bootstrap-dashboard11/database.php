        ...
        public function displayproduct()
         {
            ...
            $res=$conn->query("select q.*,a.*,s.* from question_tbl q,subject_tbl s,answer_tbl a where q.fk_sub_id=s.subject_id");
            return $res;
         ...
         {
             $conn= productadmin::connect();
            $res=$conn->query("select q.*,a.*,s.* from question_tbl q,subject_tbl s,answer_tbl a where a.fk_question_id=q.question_id and q.fk_sub_id=s.subject_id and question_id='". $_id ."'");
            return $res;
             productadmin::disconnect();
         }
           ...
           public function mutidelete($all)
         {
          ...
          public function mutideletecat($all)
         {
             $conn=productadmin::connect();
