...
<!--<img class="img-responsive iamgurdeeposahan" alt="iamgurdeeposahan" src="./gurdeeposahan.jpg">
...
echo '<center>';
echo '<h2>'.$row["name"].'</h2>';
//echo '    <h2>Gurdeep Osahan  <small><i class="fa fa-map-marker"></i> India (Punjab)</small></h2>';
echo '</center>';
?>
    ...
    -->
    	...
    	<!--li>
            ...
            echo'	<li><a href="#"><i class="fa fa-calendar left-none"></i> Email_ID : '.$row["email_id"].'</a></li>';
			echo'	<li><a href="#"><i class="fa fa-calendar left-none"></i> MOBILE_NO : '.$row["mobile_no"].'</a></li>';
			echo'	<li><a href="#"><i class="fa fa-calendar left-none"></i> GENDER : '.$row["gender"].'</a></li>';
			?>
            
            </ul>
		</li>
		<li class="default open">
			<div class="link"><i class="fa fa-code"></i>Account Settings<i class="fa fa-chevron-down"></i></div>
			<ul class="submenu">
							<li><a href="changepass.php"><i class="fa fa-calendar left-none"></i>Change Password</a></li>
