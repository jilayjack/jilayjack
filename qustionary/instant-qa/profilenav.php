    ...
    <div id="leftCol" class="left">
        ...
        <div class="siteCategories greyBox">
            <div class="greyBoxInner">
                <ul>
                    	<li class="cat-item cat-item-7"><a href="category\activities\index.htm">Change Password</a>
</li>
	<li class="cat-item cat-item-9"><a href="category\beaches\index.htm">Update Profile</a>
</li>
</ul>
...
<div class="siteCategories greyBox">
            <div class="greyBoxInner">
                <ul>
                    	<li class="cat-item cat-item-7"><a href="category\activities\index.htm">Questions</a>
</li>
	<li class="cat-item cat-item-9"><a href="category\beaches\index.htm">Answer</a>
</li>
	<li class="cat-item cat-item-4"><a href="category\car-rentals\index.htm">Users</a>
</li>
	<!--<ul class='children'>
